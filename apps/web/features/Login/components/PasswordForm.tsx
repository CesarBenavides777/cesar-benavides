  ...
  return (
    <form
      ...
      onSubmit={(e) => {
        ...
        login(usernameEmail, password, (redirectTo as string) || "/my-account");
      }}
    >
      <fieldset className="relative">
        <label
          className="ml-3 has-small-font-size font-bold tracking-wide"
      ...
      {!!Array.isArray(errors) &&
        ...
        errors.map((error, index) => (
          <p
            ...
            className="has-secondary-color font-bold has-text-align-center"
          >
            {error.toString()}
          </p>
        ))}
