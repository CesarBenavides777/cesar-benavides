...
const navigationMenuTriggerStyle =
  "group inline-flex h-8 w-max items-center justify-center rounded-md bg-none px-2 py-0 text-sm font-medium transition-colors hover:bg-slate-100 hover:text-slate-900 focus:bg-slate-100 focus:text-slate-900 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-slate-100/50 data-[state=open]:bg-slate-100/50 dark:hover:bg-night dark:hover:text-slate-50 dark:focus:bg-night dark:focus:text-slate-50 dark:data-[active]:bg-night/50 dark:data-[state=open]:bg-night/50";
